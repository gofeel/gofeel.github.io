...
사실 내가 만든 것은 기존의 방식으로 테스트할 수 없는 앱을 테스트하기 위한 도구를 만든 것이었고, 수도쿠를 푸는 것은 예시중 하나였다. 해외에는 관련 서비스를 서비스하는 회사도 있고, 사실 몇몇은 이런 포인트를 이해해서, 가볍게 이야기 하기도 했었다. [관련 내용은 별도로 적어 두었다.]({{< ref "/posts/test_with_3d_printer" >}})
